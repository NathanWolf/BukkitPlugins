...
{
	public PersistedClass(PersistClass entityInfo)
	{
	...
	public boolean bind(Class<? extends Object> persistClass)
	{
		...
		for (Field classField : persistClass.getDeclaredFields())
		{
			...
			if (persist != null)
			{
				PersistedField field = PersistedField.tryCreate(persist, classField, this);		
				if (field == null)
				{
		...
		for (Method method : persistClass.getDeclaredMethods())
		{
			...
			if (persist != null)
			{
				PersistedField field = PersistedField.tryCreate(persist, method, this);
				if (field == null)
				{
	...
	public PersistedField persistField(String fieldName, PersistField fieldInfo)
	{
		PersistedField persistField = null;
		Method getter = PersistedField.findGetter(fieldName, persistClass);
	...
	public boolean addField(PersistedField field, PersistField persist)
	{
		if (persist.id())
		{
			if (idField != null)
	...
	protected PersistClass					entityInfo			= null;
