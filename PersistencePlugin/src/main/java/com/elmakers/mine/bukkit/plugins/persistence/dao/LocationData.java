 ...
 * for ease of object interaction. Use locationFactory(Server) to generate a
 * new concrete instance of the bukkit Location class.
 *
 * @author amkeyte
 */
...
public class LocationData {
    ...
    /**
     * Default constructor for uninitialized LocationData
     * Use setters for blockVector,orientation, and worldData
     * before attempting to "put" this object.
     */
    public LocationData() {
    }
    ...
    /**
     * initialize the orientation instance.
    ...
    /**
     * initialize the block vector instance.
     * for use in constructor
     * @return BlockVector
     */
    ...
    /* initialize the worldData instance.
     *for use in constructor
     * @return WorldData
     */
