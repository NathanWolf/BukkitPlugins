...
public class PersistedField
{
	...
	/**
	 * This will check to see if either entity info (annotations)
	 * specify this is a contained field
	 * 
	...
	/**
	 * Check to see if this object is inside a container (it should be,
	 * if it's a contained object - but _may_ be even if not contained!)
	 * 
